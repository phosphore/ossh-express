...
exports = module.exports = function(app, passport) {
  ...
  //dashboard
  app.get('/dashboard', require('./views/dashboard/dashboard').init);
  app.get('/search/project/:projectName', require('./views/dashboard/dashboard').search);

  //project page
  app.get('/project/:projectOwner/:projectName', require('./views/project/index').init);
  //project endpoints
  app.get('/project/:projectOwner/:projectName/join', require('./views/project/index').join);
  app.post('/project/:projectOwner/:projectName/editLongDescription', require('./views/project/index').editLongDescription);
  app.put('/project/:projectOwner/:projectName/team/:member/accept', require('./views/project/index').acceptTeamMember);
  app.put('/project/:projectOwner/:projectName/team/:member/decline', require('./views/project/index').declineTeamMember);
  app.put('/project/:projectOwner/:projectName/team/:member/remove', require('./views/project/index').removeTeamMember);

  //submission endpoints
  app.get('/submission/:projectOwner/:projectName/new', require('./views/submission/submission').compileNewSubmission);
  app.post('/submission/:projectOwner/:projectName/new', require('./views/submission/submission').saveNewSubmission);
  app.get('/submission/:projectOwner/:projectName/get/:submissionid', require('./views/submission/submission').getSubmission);

  //avatar generator
  app.get('/avatar/generate', require('./views/avatar/generate').init);
  app.get('/avatar/:id', require('./views/avatar/get').init);

  //sign up project
  app.get('/join/project', require('./views/join/project/index').init);
  app.post('/join/project', require('./views/join/project/index').signup);
  
  //sign up researcher
  app.get('/join/researcher', require('./views/join/researcher/index').init);
  app.post('/join/researcher', require('./views/join/researcher/index').signup);
